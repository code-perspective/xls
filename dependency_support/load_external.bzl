...
load("@com_google_xls//dependency_support/boost:workspace.bzl", repo_boost = "repo")
load("@com_google_xls//dependency_support/llvm:workspace.bzl", repo_llvm = "repo")
load("@com_google_xls//dependency_support/rules_hdl:workspace.bzl", repo_rules_hdl = "repo")
...
def load_external_repositories():
    ...
    http_archive(
        ...
        build_file = "@com_google_xls//dependency_support/com_github_facebook_zstd:bundled.BUILD.bazel",
    )
